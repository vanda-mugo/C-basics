...
//    vector <char> vowels;         // empty , vector of size zero
//    vector <char> vowels (5);      // 5 initialized to zero 
    vector <char> vowels {'a' , 'e', 'i', 'o', 'u'}; // vector of characters that has 5 characters which each have a value of their own
