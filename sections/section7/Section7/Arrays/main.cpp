...
//    
    ...
    // its best practice to initialize arrays when you declare them
    int test_scores [5] {100,96,95,87,88};
    // to initialise all array elements to 0
    int this_array [8]{};
    // each element in this array is initialised to zero
    return 0;
}
